  ...
  return (
    <>
      ...
      <div className="card" id="card">
        ...
        />
        <div className="card-content">
          <h2 className="card-title"> Dique El Jumeal</h2>
          <p className="card-description">
            El Dique El Jumeal es una represa ubicada cerca de San Fernando del
            Valle de Catamarca, Argentina. Se utiliza para el almacenamiento de
            agua, la regulación del caudal y el riego agrícola, y también es un
            lugar popular para actividades recreativas.
          </p>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d224679.84869732868!2d-65.9440135!3d-28.3702564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9424287e17555d0f%3A0xf5cff60acb642953!2sDique%20El%20Jumeal!5e0!3m2!1ses-419!2sar!4v1725200893912!5m2!1ses-419!2sar"></iframe>
        </div>
      </div>
      <div className="card" id="card">
        <img
        ...
        <div className="card-content">
          ...
          <p className="card-description">
            El Parque Adán Quiroga es un espacio verde ubicado en San Fernando
            del Valle de Catamarca, Argentina. Ofrece áreas de recreación,
            senderos, y espacios para eventos y actividades al aire libre. Es un
            lugar popular para el esparcimiento y actividades familiares.
          </p>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d224679.84869732868!2d-65.9440135!3d-28.3702564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x942428a96b657f8b%3A0xd2fadde4b44898e4!2sParque%20Ad%C3%A1n%20Quiroga!5e0!3m2!1ses-419!2sar!4v1725201008747!5m2!1ses-419!2sar"></iframe>
        </div>
      </div>
      <div className="card" id="card">
        <img
        ...
        <div className="card-content">
          ...
          <p className="card-description">
            El Parque de los Vientos es un parque ubicado en San Fernando del
            Valle de Catamarca, Argentina. Destaca por su diseño paisajístico,
            espacios verdes y áreas recreativas, y es conocido por su ambiente
            tranquilo y agradable para el esparcimiento.
          </p>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d224679.84869732868!2d-65.9440135!3d-28.3702564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94242945140abdc1%3A0x97c25d368732db3!2sParque%20de%20Los%20Vientos!5e0!3m2!1ses-419!2sar!4v1725200958395!5m2!1ses-419!2sar"></iframe>
        </div>
      </div>
      <div className="card" id="card">
        <img
        ...
        <div className="card-content">
          ...
          <p className="card-description">
            El Dique Las Pirquitas es una represa situada en la provincia de
            Catamarca, Argentina. Se utiliza para la regulación del agua, el
            riego agrícola y la generación de energía hidroeléctrica, además de
            ser un lugar para actividades recreativas como la pesca.
          </p>
