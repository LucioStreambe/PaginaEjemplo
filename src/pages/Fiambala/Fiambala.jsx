    ...
    <>
      <div className="card" id="card">
        ...
        <div className="card-content">
          <h2 className="card-title">Duna Mágica de Fiambalá </h2>
          ...
          </p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1810873.832820964!2d-69.91602560625!3d-27.566763399999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x969e32e507f9d14b%3A0x1c0a5f6153489121!2sDuna%20M%C3%A1gica!5e0!3m2!1ses-419!2sar!4v1725204852483!5m2!1ses-419!2sar"></iframe>
        </div>
      </div>
      <div className="card" id="card">
        <img
        ...
        />
        <div className="card-content">
          <h2 className="card-title">Museo del Hombre</h2>
          <p className="card-description">
      ...
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipP2eVWfMJmXv5Z5GUZI2LMZR7eeGY3eMXeg8mZG=w203-h152-k-no"
          alt="Dunitas "
        />
        <div className="card-content">
          <h2 className="card-title">Dunitas </h2>
          <p className="card-description">
      ...
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipOaP55Uz__BXNPGsKgcE5vZLXbQzey2ED4ctLk=w203-h152-k-no"
          alt="Termas de Fiambalá "
        />
        <div className="card-content">
          <h2 className="card-title">Termas de Fiambalá </h2>
          <p className="card-description">
