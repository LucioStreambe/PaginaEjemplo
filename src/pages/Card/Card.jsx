  ...
  return (
    <>
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipMOZanutfDvI2ZWjVCBgfUK4UcF_NpWOLe__ZsJ=w203-h114-k-no"
      ...
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipPjRWBzNHW_8EheHdM_V1DpEINsF-fXsGXdAKM=w210-h100-k-no"
          alt="San Fernando Del Valle De Catamarca"
          className="card-img"
        />
        <div className="card-content">
          <h2 className="card-title">San Fernando Del Valle De Catamarca</h2>
          <p className="card-description">
            Fiambalá es una localidad del Departamento Tinogasta en el oeste de
            la provincia argentina de Catamarca, y es la última ciudad que
            alberga la RN 60 antes de adentrarse camino a la República de Chile.
      ...
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipMQz1d7zq7m5rBhB2QVfRh8cbXE46z3Lj8qOvEw=w408-h272-k-no"
          alt="San Fernando Del Valle De Catamarca"
          className="card-img"
        />
        <div className="card-content">
          <h2 className="card-title">San Fernando Del Valle De Catamarca</h2>
          <p className="card-description">
            Tinogasta es la ciudad capital del departamento homónimo, en el
            oeste de la provincia argentina de Catamarca; sobre la costa derecha
            del río Abaucán, a 282 km de la capital provincial San Fernando del
            Valle de Catamarca
          </p>
          <li className="card-link">
      ...
      <div className="card" id="card">
        <img
          src="https://lh5.googleusercontent.com/p/AF1QipNM044shEURJbJX57iBpxRuDtdL5YfII0hXJNeo=w213-h120-k-no"
          alt="San Fernando Del Valle De Catamarca"
          className="card-img"
        />
        <div className="card-content">
          ...
          <li className="card-link">
            <a href="AntofagastaDeLaSierra">ver mas</a>
          </li>
